...
async function getStaticProps() {
  //fetch data from api
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://patrick:php980825@meetup-cluster.fscfa3s.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
